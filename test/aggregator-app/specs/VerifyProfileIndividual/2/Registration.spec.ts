...
const random = randomEmail({ domain: 'automatedtesters.com' })
const randomLastName = random.replace('@automatedtesters.com', '')
const data = {
  "email": random,
...
describe("Registration", () => {
  ...
  it("Set first name and last name inputs", () => {
    ...
    signUpPage.clickCorporateText()
    signUpPage.setCompanyNameInputAndClickNext(data.firstName)
  });
